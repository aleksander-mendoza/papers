...
It achieves a regularization effect similar to entropy maximization. 

Empirically soft-WTA converges and produces complex patterns not only when and possibly others. It remains an open question how those different settings relate to each other, why they converge and whether one of them could hold the key to outperforming deep nets in more complex tasks than MNIST recognition.
\fi
