...
It is worthwhile to compare the efficiency of this method with temporal difference learning, which requires multiple passes over the same state to converge. Inference of groups could also hold the key to transfer learning, as many environments with different reward landscapes could share the same underlying group structures.
